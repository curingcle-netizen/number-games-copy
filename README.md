...
이 폴더만 [GitHub 저장소](https://github.com/curingcle-netizen/number-games-copy)의 `main` 브랜치에서 GitHub Pages로 게시합니다. 앱이 읽는 문구 주소는 [copy.json](https://curingcle-netizen.github.io/number-games-copy/copy.json)입니다. 앱 원본의 `localization/publication.json`에도 같은 주소를 설정합니다.
